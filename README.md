...
8. databricks fs cp -r my_project dbfs:/Volumes/my_catalog/my_schema/my_volume

* databricks auth login --host https://dbc-84d873a5-607b.cloud.databricks.com/
* # Initialize a new Databricks Asset Bundle
databricks bundle init default-python

# Validate bundle configuration
databricks bundle validate

# Deploy bundle to a specific environment
